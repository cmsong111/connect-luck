...
//        User user = userRepository.findByEmail(email);
//        if (eventId == null) {
//            return eventApplicationRepository.findAllByEventManagerId(user.getId());
//        }
//        return eventApplicationRepository.findAllByEventManagerIdAndEventId(user.getId(), eventId);
//    }
//
//    /**
//     * 지원서 신규 작성 메소드
...
////        if (!eventApplication.getEvent().getId()(eventId)) {
